...
#include <gdbm.h>
    ...
    GDBM_FILE start_bd(char string[]){// recebe o nome da base de dados a abrir
        ...
        db = gdbm_open(string, 0, GDBM_WRCREAT, 0, NULL); //GDBM_WRCREAT serve para leitura e escrita e cria a base de dados se ela não existir
        if (db == NULL) {
